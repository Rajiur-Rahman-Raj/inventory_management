                            ...
                            <div id="tab1" class="content active">
                                <form action="{{ route('user.companyUpdate', $singleCompany->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        @if($singleCompany->centralPromoter)
                                            <div class="row">
                                        ...
                                        <div class="row centralPromoterForm">
                                            <div class="input-box col-md-6 mt-4 mb-4">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ old('promoter_name', optional($singleCompany->centralPromoter)->name) }}"/>
                                            ...
                                            <div class="input-box col-md-6 mt-4 mb-4">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ old('promoter_email', optional($singleCompany->centralPromoter)->email) }}"/>
                                            ...
                                            <div class="input-box col-md-6 mb-4">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ old('promoter_phone', optional($singleCompany->centralPromoter)->phone) }}"/>
                                                @if($errors->has('promoter_email'))
                                                    <div
                                            ...
                                            <div class="input-box col-md-6">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ optional($singleCompany->centralPromoter)->promoter_commission }}"/>
                                            ...
                                            <div class="input-box col-12  mb-4">
                                                ...
                                                <textarea
                                                    ...
                                                    name="promoter_address" value="{{ optional($singleCompany->centralPromoter)->address }}">{{ old('promoter_address', optional($singleCompany->centralPromoter)->address) }}</textarea>

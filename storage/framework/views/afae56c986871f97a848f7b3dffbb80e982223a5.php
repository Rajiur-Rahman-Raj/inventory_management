        ...
        <div class="card-body">
            ...
            <?php if(adminAccessRoute(config('role.manage_role.access.add'))): ?>
                <div class="d-flex justify-content-end mb-2 text-right">
                    <button  data-target="#addModal"  data-toggle="modal"  class="btn btn-primary btn-rounded btn-sm"><i class="fa fa-user-plus"></i> <?php echo e(trans('Create New')); ?> </button>
                </div>
            <?php endif; ?>
                ...
                <table class="categories-show-table table table-hover table-striped table-bordered">
                    ...
                    <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <span  class="custom-badge  badge-pill  bg-<?php echo e($data->status == 0 ? 'danger' : 'success'); ?>"><?php echo e($data->status == 0 ? 'Deactive' : 'Active'); ?></span>
                            </td>
                            <?php if(adminAccessRoute(config('role.manage_role.access.edit'))): ?>
                                                        ...
                                                        <div class="row permissionInputLebel">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input class="form-control " name="email"
                                                                       placeholder="Email Address" value="<?php echo e($data->email); ?>" autocomplete="off"
                                                                       required>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <div class="card m-0">
                                                                    ...
                                                                    <div class="card-body select-all-access pb-0">
                                                                        <div class="form-group">
                                                                            <label><input type="checkbox" class="selectAll mr-1" name="accessAll"> <?php echo e(trans('Select All')); ?></label>
                                                                        </div>
                                                                        ...
                                                                        <table class=" table table-hover table-striped table-bordered text-center">
                                                                            ...
                                                                            <?php $__currentLoopData = config('role'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <tr>
                                                                                    <td class="text-left"><?php echo e($value['label']); ?></td>
                                                                                    <td data-label="View">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content ">
                ...
                <form role="form" method="POST" class="actionRoute" action="<?php echo e(route('admin.storeStaff')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger btn-rounded" data-dismiss="modal"><?php echo app('translator')->get('Close'); ?></button>
                        <button type="submit" class="btn btn-primary btn-rounded" ><?php echo app('translator')->get('Save'); ?></button>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\inventory_management\project\resources\views/admin/staff/index.blade.php ENDPATH**/ ?>
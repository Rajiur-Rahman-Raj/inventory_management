                ...
                <div class="col">
                    <div class="d-flex justify-content-between mb-4">
                        <div class="header-text-full">
                            <h3 class="dashboard_breadcurmb_heading mb-1">@lang('Create Employee')</h3>
                            <nav aria-label="breadcrumb" class="ms-2">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('user.home') }}">@lang('Dashboard')</a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page">@lang('Create Employee')</li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="row g-4 g-lg-5">
                        <div class="col-lg-12">
                            <div id="tab1" class="content active">
                                <form action="{{ route('user.employeeStore')}}" method="post"
                                    ...
                                    <div class="row g-4">
                                            ...
                                            <div class="flatpickr">
                                                <div class="input-group">
                                                    <input type="date"
                                                           ...
                                                           name="joining_date"
                                                           value="{{ old('joining_date',request()->joining_date) }}"
                                                           data-input>
                                                    <div class="input-group-append"
                                                         readonly="">
                                                        <div
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <select class="form-select js-example-basic-single"
                                                ...
                                                <option value="1" {{ old('employee_type', request()->employee_type) == 1 ? 'selected' : ''}}> @lang('Full Time') </option>
                                                <option value="2" {{ old('employee_type', request()->employee_type) == 2 ? 'selected' : ''}}> @lang('Part Time') </option>
                                            </select>
                                        ...
                                        <div class="input-box col-12">
                                            ...
                                            <textarea
                                                ...
                                                value="{{old('present_address')}}">{{ old('present_address') }}</textarea>
                                        ...
                                        <div class="input-box col-12">
                                            ...
                                            <textarea
                                                ...
                                                value="{{old('permanent_address')}}">{{ old('permanent_address') }}</textarea>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <select class="form-select js-example-basic-single"
                                                ...
                                                <option value="0" {{ old('status', request()->status) == 2 ? 'selected' : ''}}> @lang('Deactive') </option>
                                            </select>

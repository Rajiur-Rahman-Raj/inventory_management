                        ...
                        <ul class="list-group">
                            ...
                            <?php if($user->last_level != null): ?>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <?php echo app('translator')->get('Badge'); ?>
                                    <div class="d-flex no-block align-items-center">
                                        <div class="row">
                                            <?php $__currentLoopData = $allBadges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="badge-box badge-box-two <?php echo e($user->getBadges($badge->id) == true ? '' : 'locked'); ?>" id="badge-box-two">
                                                    <img src="<?php echo e(getFile(config('location.badge.path').$badge->badge_icon)); ?>" alt=""  data-toggle="tooltip" data-placement="top" title="<?php echo e(optional($badge->details)->rank_level); ?> (<?php echo e(optional($badge->details)->rank_name); ?>)"/>
                                                    <div class="lock-icon">
            ...
            <div class="modal-content">
                <form method="post" action="<?php echo e(route('admin.user-balance-update',$user->id)); ?>"
                    ...
                    <div class="modal-body">
                        <div class="form-group ">
                            <label><?php echo e(trans('Select Wallet')); ?></label>
                            <select name="walet" class="form-control">
                                <option value="" disabled><?php echo app('translator')->get('Select Walet'); ?></option>
                                <option value="main_balance" class="text-white bg-dark"><?php echo e(trans('Main balance')); ?></option>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\inventory_management\project\resources\views/admin/users/edit-user.blade.php ENDPATH**/ ?>
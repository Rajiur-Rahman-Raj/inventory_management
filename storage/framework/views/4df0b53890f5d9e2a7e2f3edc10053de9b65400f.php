<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Create a Property'); ?>
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            <div class="media mb-4 justify-content-end">
                <a href="<?php echo e(route('admin.propertyList', ['all'])); ?>" class="btn btn-sm btn-rounded btn-primary mr-2">
            ...
            <div class="tab-content mt-4" id="myTabContent">
                <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane fade <?php echo e($loop->first ? 'show active' : ''); ?>" id="lang-tab-<?php echo e($key); ?>"
                         role="tabpanel">
                        <form method="post" action="<?php echo e(route('admin.propertyStore', $language->id)); ?>"
                              enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="card">
                                <div class="card-header text-primary">
                                    <li><span class="propertyDetailsLabel"><?php echo app('translator')->get('Add Property Details'); ?></span></li>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="property_title[<?php echo e($language->id); ?>]"
                                                       value="<?php echo e(old('property_title'.'.'.$language->id)); ?>"
                                                       placeholder="<?php echo app('translator')->get('Property title'); ?>"
                                                       class="form-control <?php $__errorArgs = ['property_title'.'.'.$language->id];
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="address_id" class="form-control  type addressList">
                                                        ...
                                                        <?php $__currentLoopData = $allAddress; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option
                                                                value="<?php echo e($address->id); ?>" <?php echo e(old('address_id') == $address->id ? 'selected' : ''); ?>><?php echo app('translator')->get(optional($address->details)->title); ?></option>
                                            ...
                                            <div class="col-md-3 col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="location" value="<?php echo e(old('location')); ?>"
                                                           placeholder="<?php echo app('translator')->get('only embed url accepted'); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    <?php $__currentLoopData = $allAmenities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amenity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option
                                                            value="<?php echo e($amenity->id); ?>" <?php echo e(in_array($amenity->id, (array) old('amenity_id')) ? 'selected' : ''); ?>><?php echo app('translator')->get(optional($amenity->details)->title); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    value="<?php echo e(old('details'.'.'.$language->id)); ?>"><?php echo e(old('details'.'.'.$language->id)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <?php if($loop->index == 0): ?>
                                            <div class="col-md-5 col-xl-5 col-12">
                                                <div class="form-group">
                                                    <label for="thumbnail"><?php echo e(__('Thumbnail')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-switch-btn">
                                                        <input type='hidden' value='1'
                                                               name="is_featured" <?php echo e(old('is_featured') == "1" ? 'checked' : ''); ?>>
                                                        <input type="checkbox" name="is_featured" id="is_featured"
                                                               class="custom-switch-checkbox"
                                                               value="0" <?php echo e(old('is_featured') == "0" ? 'checked' : ''); ?>>
                                            ...
                                            <div class="col-md-4 col-xl-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-switch-btn">
                                                        <input type='hidden' value='1'
                                                               name="is_available_funding" <?php echo e(old('is_available_funding') == "1" ? 'checked' : ''); ?>>
                                                        <input type="checkbox" name="is_available_funding" id="is_available_funding"
                                                               class="custom-switch-checkbox"
                                                               value="0" <?php echo e(old('is_available_funding') == "0" ? 'checked' : ''); ?>>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 col-xl-2 mt-4 mb-3 pl-2 pr-2 pt-1 pb-1">
                                            <a href="javascript:void(0)" class="btn btn-primary btn-rounded generate"
                                               data-lang="<?php echo e($language->id); ?>"><i
                                                    class="fa fa-plus-circle"></i> <?php echo app('translator')->get('Add FAQ'); ?></a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-switch-btn">
                                                    <input type='hidden' value='1'
                                                           name="is_invest_type" <?php echo e(old('is_invest_type') == "1" ? 'checked' : ''); ?>>
                                                    <input type="checkbox" name="is_invest_type" id="is_invest_type"
                                                           class="custom-switch-checkbox"
                                                           value="0" <?php echo e(old('is_invest_type') == "0" ? 'checked' : ''); ?>>
                                        ...
                                        <div class="col-md-3 col-xl-3 fixedAmount d-none <?php echo e(old('is_invest_type') == "0" ? 'd-block' : 'd-none'); ?>">
                                            <div class="form-group">
...
unset($__errorArgs, $__bag); ?>"
                                                           placeholder="0.00" value="<?php echo e(old('fixed_amount')); ?>" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')"
                                                           id="fixedAmount"
                                                           autocomplete="off">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-3 col-xl-3 rangeAmount <?php echo e(old('is_invest_type') == "0" ? 'd-none' : ''); ?>">
                                            <div class="form-group">
...
unset($__errorArgs, $__bag); ?>"
                                                           placeholder="0.00" value="<?php echo e(old('minimum_amount')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                           placeholder="0.00" value="<?php echo e(old('maximum_amount')); ?>"
                                                           onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                                    <div class="input-group-append">
                                                <span
                                                    class="input-group-text"><?php echo app('translator')->get(config('basic.currency_symbol')); ?></span>
...
unset($__errorArgs, $__bag); ?>"
                                                           placeholder="0.00"
                                                           value="<?php echo e(old('total_investment_amount')); ?>"
                                                           onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                                    <div class="input-group-append">
                                                        <span
                                                            class="input-group-text"><?php echo app('translator')->get(config('basic.currency_symbol')); ?></span>
...
unset($__errorArgs, $__bag); ?>"
                                                           placeholder="0.00" value="<?php echo e(old('profit')); ?>"
                                                           onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                                    <div class="input-group-append">
                                                        <select name="profit_type" id="profit_type"
                                                            ...
                                                            <option
                                                                value="0"><?php echo app('translator')->get(config('basic.currency_symbol')); ?></option>
                                                        </select>
                                                    </div>
                                                </div>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-3 col-xl-3 acceptInstallments <?php echo e(old('is_invest_type') == "0" ? '' : 'd-none'); ?>">
                                            <div class="form-group">
                                                <label><?php echo app('translator')->get('Accept Installments'); ?></label>
                                                <div class="custom-switch-btn">
                                                    <input type='hidden' value='1'
                                                           name="is_installment" <?php echo e(old('is_installment') == "1" ? 'checked' : ''); ?>>
                                                    <input type="checkbox" name="is_installment" id="is_installment"
                                                           class="custom-switch-checkbox"
                                                           value="0" <?php echo e(old('is_installment') == "0" ? 'checked' : ''); ?>>
                                        ...
                                        <div class="col-md-3 col-xl-3 installmentField <?php echo e(old('is_invest_type') == "0" && old('is_installment') == "1" ? '' : 'd-none'); ?>">
                                            <div class="form-group">
...
unset($__errorArgs, $__bag); ?>"
                                                           ...
                                                           placeholder="min 1" value="<?php echo e(old('total_installments')); ?>"
                                                           onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                                </div>
...
unset($__errorArgs, $__bag); ?>"
                                                           placeholder="0.00" value="<?php echo e(old('installment_amount')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                           value="<?php echo e(old('installment_duration')); ?>"
                                                    ...
                                                    <div class="input-group-append">
                                                        <select class="form-control installment_duration_type"
                                                            ...
                                                            <option value="Days" <?php echo e(old('installment_duration_type') == 'Days' ? 'selected' : ''); ?>><?php echo app('translator')->get('Day(s)'); ?></option>
                                                            <option value="Months" <?php echo e(old('installment_duration_type') == 'Months' ? 'selected' : ''); ?>><?php echo app('translator')->get('Month(s)'); ?></option>
                                                            <option value="Years" <?php echo e(old('installment_duration_type') == 'Years' ? 'selected' : ''); ?>><?php echo app('translator')->get('Year(s)'); ?></option>
                                                        </select>
                                                    </div>
                                                </div>
...
unset($__errorArgs, $__bag); ?>"
                                                           placeholder="0.00" value="<?php echo e(old('installment_late_fee')); ?>"
                                                           onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                                    <div class="input-group-append">
                                                        <span
                                                            class="input-group-text"><?php echo app('translator')->get(config('basic.currency_symbol')); ?></span>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-3 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-switch-btn">
                                                    <input type='hidden' value='1'
                                                           name="is_return_type" <?php echo e(old('is_return_type') == "1" ? 'checked' : ''); ?>>
                                                    <input type="checkbox" name="is_return_type" id="is_return_type"
                                                           class="custom-switch-checkbox"
                                                           value="0" <?php echo e(old('is_return_type') == "0" ? 'checked' : ''); ?>>
                                        ...
                                        <div class="col-md-3 col-xl-3 howManyTimes <?php echo e(old('is_return_type') == "0" ? '' : 'd-none'); ?>">
                                            <div class="form-group">
...
unset($__errorArgs, $__bag); ?>"
                                                           placeholder="min 1" value="<?php echo e(old('how_many_times')); ?>"
                                                           onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                                </div>
...
unset($__errorArgs, $__bag); ?>">
                                                    ...
                                                    <?php $__currentLoopData = $allSchedule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option
                                                            value="<?php echo e($schedule->id); ?>" <?php echo e(old('how_many_days')  == $schedule->id ? 'selected' : ''); ?>><?php echo app('translator')->get($schedule->time); ?> <?php echo app('translator')->get($schedule->time_type); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-3 col-xl-3 mt-2">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-switch-btn">
                                                    <input type='hidden' value='1'
                                                           name="is_investor" <?php echo e(old('is_investor') == "1" ? 'checked' : ''); ?>>
                                                    <input type="checkbox" name="is_investor" id="is_investor"
                                                           class="custom-switch-checkbox"
                                                           value="0" <?php echo e(old('is_investor') == "0" ? 'checked' : ''); ?>>
                                        ...
                                        <div class="col-md-3 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-switch-btn">
                                                    <input type='hidden' value='1'
                                                           name="is_capital_back" <?php echo e(old('is_capital_back') == "1" ? 'checked' : ''); ?>>
                                                    <input type="checkbox" name="is_capital_back" id="is_capital_back"
                                                           class="custom-switch-checkbox"
                                                           value="0" <?php echo e(old('is_capital_back') == "0" ? 'checked' : ''); ?>>
                                        ...
                                        <div class="col-md-3 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <input type="datetime-local" class="form-control start_date" name="start_date" value="<?php echo e(old('start_date',request()->start_date)); ?>" placeholder="<?php echo app('translator')->get('Start date'); ?>" autocomplete="off"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <input type="datetime-local" class="form-control expire_date" name="expire_date" value="<?php echo e(old('expire_date',request()->expire_date)); ?>" placeholder="<?php echo app('translator')->get('Expire date'); ?>" autocomplete="off"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 col-xl-3">
                                            <div class="form-group ">
                                                ...
                                                <div class="custom-switch-btn">
                                                    <input type='hidden' value='1'
                                                           name='status' <?php echo e(old('status') == "1" ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\chaincity_update\project\resources\views/admin/property/create.blade.php ENDPATH**/ ?>
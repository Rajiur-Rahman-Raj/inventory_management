                ...
                <div class="card mb-4 shadow">
                    <div class="card-body">
                        ...
                        <div class="media align-items-center justify-content-between mb-3">
                            ...
                            <a href="<?php echo e(route('admin.content.index',$content)); ?>" class="btn btn-sm btn-primary btn-rounded"> <i class="fas fa-arrow-left"></i> <?php echo app('translator')->get('Back'); ?></a>
                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\inventory_management\project\resources\views/admin/content/create.blade.php ENDPATH**/ ?>
...
@section('title',trans('Edit Staff'))
                ...
                <div class="col">
                    <div class="d-flex justify-content-between mb-4">
                        <div class="header-text-full">
                            <h3 class="dashboard_breadcurmb_heading mb-1">@lang('Edit Staff')</h3>
                            <nav aria-label="breadcrumb" class="ms-2">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">@lang('Edit Staff')</li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="row g-4 g-lg-5">
                        <div class="col-lg-12">
                            <div id="tab1" class="content active">
                                <form action="{{ route('user.role.staffUpdate', $singleStaff->id)}}" method="post"
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <select class="form-select js-example-basic-single"
                                                ...
                                                @foreach($roles as $role)
                                                    <option
                                                        value="{{ $role->id }}" {{ old('role_id', $singleStaff->role_id) == $role->id ? 'selected' : ''}}> @lang($role->name)</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('name', $singleStaff->name) }}"/>
                                            @if($errors->has('name'))
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="email"
                                                   ...
                                                   value="{{ old('email', $singleStaff->email) }}"/>
                                            @if($errors->has('email'))
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   class="form-control"
                                                   value="{{ old('phone', $singleStaff->phone) }}"/>
                                            @if($errors->has('phone'))
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('username', $singleStaff->username) }}"/>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <select class="form-select js-example-basic-single" name="status"
                                                    aria-label="Default select example">
                                                <option
                                                    value="1" {{ old('status', $singleStaff->status) == 1 ? 'selected' : ''}}> @lang('Active') </option>
                                                <option
                                                    value="0" {{ old('status', $singleStaff->status) == 0 ? 'selected' : ''}}> @lang('Deactive') </option>
                                            </select>

                                            @if($errors->has('status'))
                                                <div class="error text-danger">@lang($errors->first('status'))</div>
                                            @endif
                                        </div>

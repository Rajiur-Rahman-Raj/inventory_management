                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <input type="text" class="form-control "
                                               ...
                                               value="<?php echo e(old('convention_rate')); ?>"
                                               required>
                                ...
                                <div class="form-group col-md-6 col-6">
                                    ...
                                    <div class="input-group ">
                                        <input type="text" class="form-control "
                                               ...
                                               value="<?php echo e(old('percentage_charge')); ?>"
                                               required="">
                                        <div class="input-group-append">
                                            <div class="input-group-text">
                                                <?php echo e(trans('%')); ?>
                                ...
                                <div class="col-sm-6 col-md-3">
                                   <div class="form-group">
                                       ...
                                       <div class="image-input ">
                                           ...
                                           <img id="image_preview_container" class="preview-image" src="<?php echo e(getFile(config('location.gateway.path'))); ?>"
                                                alt="preview image">
                                       </div>
                                   </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-sm-12 col-md-9">
                                    <div class="form-group ">
                                        ...
                                        <textarea class="form-control summernote" name="note" id="summernote" rows="15"><?php echo e(old('note')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\inventory_management\project\resources\views/admin/payment_methods/manual/create.blade.php ENDPATH**/ ?>
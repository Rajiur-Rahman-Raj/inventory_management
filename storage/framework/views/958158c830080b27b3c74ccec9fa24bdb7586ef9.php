            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-md-4 col-lg-4 col-12">
                    <div class="form-group">
                        <label for="user"><?php echo app('translator')->get('User'); ?></label>
                        <input type="text" name="user" value="<?php echo e(@request()->user); ?>" class="form-control"
                ...
                <div class="col-md-4 col-lg-4 col-12">
                    <div class="form-group">
                        <label for="trx_id"><?php echo app('translator')->get('Transaction Id'); ?></label>
                        <input type="text" name="trx_id" value="<?php echo e(@request()->trx_id); ?>" class="form-control"
                        ...
                        <tr>
                            <td data-label="<?php echo app('translator')->get('Name'); ?>">
                                <a href="<?php echo e(route('admin.user-edit',[$fund->user_id])); ?>" target="_blank">
                                    <div class="d-flex no-block align-items-center">
                                        <div class="mr-3"><img src="<?php echo e(getFile(config('location.user.path').optional($fund->user)->image)); ?>" alt="user" class="rounded-circle" width="45" height="45">
                                        </div>
                                        <div class="">
                                            <h5 class="text-dark mb-0 font-16 font-weight-medium">
                                                <?php echo app('translator')->get(optional($fund->user)->firstname); ?> <?php echo app('translator')->get(optional($fund->user)->lastname); ?>
                                            </h5>
                                            <span class="text-muted font-14"><span>@</span><?php echo app('translator')->get(optional($fund->user)->username); ?></span>
                                        </div>
                                    </div>
                                </a>
                            </td>
                            ...
                            <td data-label="<?php echo app('translator')->get('Status'); ?>">
                                <?php if($fund->status == 2): ?>
                                    <span class="custom-badge bg-warning"><?php echo app('translator')->get('Pending'); ?></span>
                                <?php elseif($fund->status == 1): ?>
                                    <span class="custom-badge bg-success"><?php echo app('translator')->get('Approved'); ?></span>
                                <?php elseif($fund->status == 3): ?>
                                    <span class="custom-badge bg-danger"><?php echo app('translator')->get('Rejected'); ?></span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                ...
                                <?php if($fund->gateway_id > 999): ?>
                                    <button
                                        class="edit_button btn  <?php echo e(($fund->status == 2) ?  'btn-outline-primary btn-rounded' : 'btn-outline-primary btn-rounded'); ?>  btn-sm "
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="100%" class="text-center">
                                <p class="text-na text-center" ><?php echo app('translator')->get('No Data Found'); ?></p>
                            </td>
                        </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\inventory_management\project\resources\views/admin/payment/logs.blade.php ENDPATH**/ ?>
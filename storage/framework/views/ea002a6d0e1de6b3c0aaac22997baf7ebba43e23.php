<?php $__env->startSection('title',trans('Edit Staff')); ?>
                ...
                <div class="col">
                    <div class="d-flex justify-content-between mb-4">
                        <div class="header-text-full">
                            <h3 class="dashboard_breadcurmb_heading mb-1"><?php echo app('translator')->get('Edit Staff'); ?></h3>
                            <nav aria-label="breadcrumb" class="ms-2">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page"><?php echo app('translator')->get('Edit Staff'); ?></li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="row g-4 g-lg-5">
                        <div class="col-lg-12">
                            <div id="tab1" class="content active">
                                <form action="<?php echo e(route('user.role.staffUpdate', $singleStaff->id)); ?>" method="post"
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <select class="form-select js-example-basic-single"
                                                ...
                                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        value="<?php echo e($role->id); ?>" <?php echo e(old('role_id', $singleStaff->role_id) == $role->id ? 'selected' : ''); ?>> <?php echo app('translator')->get($role->name); ?></option>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="<?php echo e(old('name', $singleStaff->name)); ?>"/>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="email"
                                                   ...
                                                   value="<?php echo e(old('email', $singleStaff->email)); ?>"/>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   class="form-control"
                                                   value="<?php echo e(old('phone', $singleStaff->phone)); ?>"/>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="<?php echo e(old('username', $singleStaff->username)); ?>"/>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <select class="form-select js-example-basic-single" name="status"
                                                    aria-label="Default select example">
                                                <option
                                                    value="1" <?php echo e(old('status', $singleStaff->status) == 1 ? 'selected' : ''); ?>> <?php echo app('translator')->get('Active'); ?> </option>
                                                <option
                                                    value="0" <?php echo e(old('status', $singleStaff->status) == 0 ? 'selected' : ''); ?>> <?php echo app('translator')->get('Deactive'); ?> </option>
                                            </select>

                                            <?php if($errors->has('status')): ?>
                                                <div class="error text-danger"><?php echo app('translator')->get($errors->first('status')); ?></div>
                                            <?php endif; ?>
                                        </div>

                                        <div class="input-box col-12">
                                            <button class="btn-custom w-100"
                                                    type="submit"><?php echo app('translator')->get('Update Staff'); ?></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\inventory_management\project\resources\views/themes/original/user/role_permission/staffEdit.blade.php ENDPATH**/ ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php if(isset($purchaseReportRecords) && count($purchaseReportRecords) > 0 && count($search) > 0): ?>
                <div class="d-flex justify-content-end mb-4">
                    <a href="javascript:void(0)" data-route="<?php echo e(route('user.export.purchaseReport')); ?>"
                        ...
                        <?php if(count($purchaseReportRecords) > 0): ?>
                            <?php $__currentLoopData = $purchaseReportRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $purchaseIn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php $__currentLoopData = $purchaseIn->rawItemDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $purchaseInDetails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td data-label="Quantity"><?php echo e($purchaseIn->supplier->name); ?></td>
                                        <td data-label="Quantity"><?php echo e($purchaseInDetails->rawItem->name); ?></td>
                                        ...
                                        <td data-label="Total Unit Cost"><?php echo e(customDate($purchaseInDetails->purchase_date)); ?></td>
                                        <td data-label="Total Unit Cost"><?php echo e($purchaseInDetails->total_unit_cost); ?> <?php echo e(config('basic.currency_symbol')); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                            <tr>
                                <td class="text-center" colspan="100%" >
                                    <img src="http://127.0.0.1/inventory_management/project/assets/global/img/no_data.gif" class="card-img-top empty-state-img" alt="..." style="width: 300px">
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if(count($purchaseReportRecords) > 0): ?>
                            <tr>
                                <td colspan="5" class="text-right"><?php echo app('translator')->get('Total Price'); ?></td>

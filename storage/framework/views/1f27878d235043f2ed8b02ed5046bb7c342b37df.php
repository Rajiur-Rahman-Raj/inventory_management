<?php $__env->startSection('title',trans('Edit Role')); ?>
                ...
                <div class="col">
                    <div class="d-flex justify-content-between mb-4">
                        <div class="header-text-full">
                            <h3 class="dashboard_breadcurmb_heading mb-1"><?php echo app('translator')->get('Edit Role'); ?></h3>
                            <nav aria-label="breadcrumb" class="ms-2">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page"><?php echo app('translator')->get('Edit Role'); ?></li>
                                </ol>
                            </nav>
                        </div>
                        <div>
                ...
                <section class="profile-setting">
                    <div class="row g-4 g-lg-5">
                        <div class="col-lg-12 m-0">
                            <form method="post" action="<?php echo e(route('user.roleUpdate', $singleRole->id)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e(old('name', $singleRole->name)); ?>">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <div class="selectgroup">
                                            <select class="form-control js-example-basic-single" name="status"
                                                ...
                                                <option
                                                    value="1" <?php echo e(old('status', $singleRole->status) == 1 ? 'selected' : ''); ?>><?php echo app('translator')->get('Active'); ?></option>
                                                <option
                                                    value="0" <?php echo e(old('status', $singleRole->status) == 0 ? 'selected' : ''); ?>><?php echo app('translator')->get('Deactive'); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                                                                ...
                                                                                <li>
                                                                                    <?php if(!empty(collect($permission)->collapse()['permission']['view'])): ?>
                                                                                        <input
                                                                                            type="checkbox"
                                                                                            value="<?php echo e(join(",",collect($permission)->collapse()['permission']['view'])); ?>"
                                                                                            <?php if(in_array_any(collect($permission)->collapse()['permission']['view'], $singleRole->permission??[] )): ?>
                                                                                                checked
                                                                                            <?php endif; ?>
                                                                            ...
                                                                            <?php if(!empty(collect($permission)->collapse()['permission']['add'])): ?>
                                                                                <li>
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           <?php if(in_array_any(collect($permission)->collapse()['permission']['add'], $singleRole->permission??[] )): ?>
                                                                                               checked
                                                                                           <?php endif; ?>
                                                                                           class="cursor-pointer"
                                                                            ...
                                                                            <?php if(!empty(collect($permission)->collapse()['permission']['edit'])): ?>
                                                                                <li>
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           <?php if(in_array_any(collect($permission)->collapse()['permission']['edit'], $singleRole->permission??[] )): ?>
                                                                                               checked
                                                                                           <?php endif; ?>
                                                                                           class="cursor-pointer"
                                                                                           name="permissions[]"/>
                                                                            ...
                                                                            <?php if(!empty(collect($permission)->collapse()['permission']['delete'])): ?>
                                                                                <li>
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           <?php if(in_array_any(collect($permission)->collapse()['permission']['delete'], $singleRole->permission??[] )): ?>
                                                                                               checked
                                                                                           <?php endif; ?>
                                                                                           class="cursor-pointer"
                                                                                           name="permissions[]"/>
                                                                                ...
                                                                                <?php if(!empty(collect($permission)->collapse()['permission']['switch'])): ?>
                                                                                    <li>
                                                                                        <input
                                                                                            ...
                                                                                            <?php if(in_array_any(collect($permission)->collapse()['permission']['switch'], $singleRole->permission??[] )): ?>
                                                                                                checked
                                                                                            <?php endif; ?>
                                                                                            class="cursor-pointer"
                                                                                            name="permissions[]"/>
                                                                                ...
                                                                                <?php if(!empty(collect($permission)->collapse()['permission']['return'])): ?>
                                                                                    <li>
                                                                                        <input
                                                                                            ...
                                                                                            <?php if(in_array_any(collect($permission)->collapse()['permission']['return'], $singleRole->permission??[] )): ?>
                                                                                                checked
                                                                                            <?php endif; ?>
                                                                                            class="cursor-pointer"
                                                                                            name="permissions[]"/>
                                                                                ...
                                                                                <?php if(!empty(collect($permission)->collapse()['permission']['export'])): ?>
                                                                                    <li>
                                                                                        <input
                                                                                            ...
                                                                                            <?php if(in_array_any(collect($permission)->collapse()['permission']['export'], $singleRole->permission??[] )): ?>
                                                                                                checked
                                                                                            <?php endif; ?>
                                                                                            class="cursor-pointer"
                                                                                            name="permissions[]"/>
                                                                                            ...
                                                                                            <?php if(!empty($subMenu['permission']['view'])): ?>
                                                                                                <li>
                                                                                                    <input
                                                                                                        ...
                                                                                                        <?php if(in_array_any($subMenu['permission']['view'], $singleRole->permission??[] )): ?>
                                                                                                            checked
                                                                                                        <?php endif; ?>
                                                                                                        class="cursor-pointer"
                                                                                                        name="permissions[]">
                                                                                            ...
                                                                                            <?php if(!empty($subMenu['permission']['add'])): ?>
                                                                                                <li>
                                                                                                    <input
                                                                                                        ...
                                                                                                        <?php if(in_array_any($subMenu['permission']['add'], $singleRole->permission??[] )): ?>
                                                                                                            checked
                                                                                                        <?php endif; ?>
                                                                                                        class="cursor-pointer"
                                                                                                        name="permissions[]"/> <?php echo app('translator')->get('Add'); ?>
                                                                                            ...
                                                                                            <?php if(!empty($subMenu['permission']['edit'])): ?>
                                                                                                <li>
                                                                                                    <input
                                                                                                        ...
                                                                                                        <?php if(in_array_any($subMenu['permission']['edit'], $singleRole->permission??[] )): ?>
                                                                                                            checked
                                                                                                        <?php endif; ?>
                                                                                                        class="cursor-pointer"
                                                                                            ...
                                                                                            <?php if(!empty($subMenu['permission']['delete'])): ?>
                                                                                                <li>
                                                                                                    <input
                                                                                                        ...
                                                                                                        <?php if(in_array_any($subMenu['permission']['delete'], $singleRole->permission??[] )): ?>
                                                                                                            checked
                                                                                                        <?php endif; ?>
                                                                                                        class="cursor-pointer"
                                                                                                ...
                                                                                                <?php if(!empty($subMenu['permission']['switch'])): ?>
                                                                                                    <li>
                                                                                                        <input
                                                                                                            ...
                                                                                                            <?php if(in_array_any($subMenu['permission']['switch'], $singleRole->permission??[] )): ?>
                                                                                                                checked
                                                                                                            <?php endif; ?>
                                                                                                            class="cursor-pointer"
                                                                                                            name="permissions[]"/>
                                                                                                ...
                                                                                                <?php if(!empty($subMenu['permission']['return'])): ?>
                                                                                                    <li>
                                                                                                        <input
                                                                                                            ...
                                                                                                            <?php if(in_array_any($subMenu['permission']['return'], $singleRole->permission??[] )): ?>
                                                                                                                checked
                                                                                                            <?php endif; ?>
                                                                                                            class="cursor-pointer"
                                                                                                            name="permissions[]"/>
                                                                                                ...
                                                                                                <?php if(!empty($subMenu['permission']['export'])): ?>
                                                                                                    <li>
                                                                                                        <input
                                                                                                            ...
                                                                                                            <?php if(in_array_any($subMenu['permission']['export'], $singleRole->permission??[] )): ?>
                                                                                                                checked
                                                                                                            <?php endif; ?>
                                                                                                            class="cursor-pointer"
                                                                                                            name="permissions[]"/>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <button type="submit"
                                    ...
                                    <?php echo app('translator')->get('Update Role'); ?>
                                </button>
                            </form>
                        </div>
                    </div>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\inventory_management\project\resources\views/themes/original/user/role_permission/editRole.blade.php ENDPATH**/ ?>
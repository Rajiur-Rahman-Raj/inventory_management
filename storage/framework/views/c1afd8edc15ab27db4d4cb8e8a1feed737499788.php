<?php $__env->startSection('title',trans('Edit Sales Center')); ?>
                ...
                <div class="col">
                    <div class="d-flex justify-content-between mb-4">
                        <div class="header-text-full">
                            <h3 class="dashboard_breadcurmb_heading mb-1"><?php echo app('translator')->get('Edit Sales Center'); ?></h3>
                            <nav aria-label="breadcrumb" class="ms-2">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page"><?php echo app('translator')->get('Edit Sales Center'); ?></li>
                                </ol>
                            </nav>
                        </div>
                        <div>
                    ...
                    <div class="row g-4 g-lg-5">
                        <div class="col-lg-12">
                            <div id="tab1" class="content active">
                                <form action="<?php echo e(route('user.updateSalesCenter', $salesCenter->id)); ?>" method="post"
                                    ...
                                    <div class="row g-4">
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="<?php echo e(old('name', $salesCenter->name)); ?>"/>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="<?php echo e(old('code', $salesCenter->code)); ?>"/>
...
unset($__errorArgs, $__bag); ?>"
                                                      ...
                                                      name="center_address" value="<?php echo e(old('center_address', $salesCenter->center_address)); ?>"><?php echo e(old('center_address', $salesCenter->center_address)); ?></textarea>
                                            <?php if($errors->has('center_address', $salesCenter->center_address)): ?>
                                                <div class="error text-danger"><?php echo app('translator')->get($errors->first('center_address')); ?></div>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   class="form-control"
                                                   value="<?php echo e(old('owner_name', optional($salesCenter->user)->name)); ?>"/>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="<?php echo e(old('phone', optional($salesCenter->user)->phone)); ?>"
                                                   class="form-control"/>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="email"
                                                   ...
                                                   value="<?php echo e(old('email', optional($salesCenter->user)->email)); ?>"
                                                   class="form-control"/>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="<?php echo e(old('username', optional($salesCenter->user)->username)); ?>"
                                                   class="form-control"/>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text" name="national_id" placeholder="<?php echo app('translator')->get('National Id'); ?>"
                                                   class="form-control" value="<?php echo e(old('national_id', $salesCenter->national_id)); ?>"/>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text" name="trade_id" placeholder="<?php echo app('translator')->get('Trade Id'); ?>"
                                                   class="form-control" value="<?php echo e(old('trade_id', $salesCenter->trade_id)); ?>"/>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <select class="form-select js-example-basic-single selectedDivision"
                                                ...
                                                <?php $__currentLoopData = $allDivisions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $division): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($division->id); ?>" <?php echo e(old('division_id', $salesCenter->division_id) == $division->id ? 'selected' : ''); ?>> <?php echo app('translator')->get($division->name); ?></option>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <select class="form-select js-example-basic-single selectedDistrict"
                                                    name="district_id"
                                                    aria-label="Default select example"
                                                    data-olddistrictid="<?php echo e(old('district_id', $salesCenter->district_id)); ?>">
                                            </select>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <select class="form-select js-example-basic-single selectedUpazila"
                                                    name="upazila_id"
                                                    aria-label="Default select example"
                                                    data-oldupazilaid="<?php echo e(old('upazila_id', $salesCenter->upazila_id)); ?>">
                                            </select>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <select class="form-select js-example-basic-single selectedUnion"
                                                    name="union_id"
                                                    aria-label="Default select example"
                                                    data-oldunionid="<?php echo e(old('union_id', $salesCenter->union_id)); ?>">
                                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                                      ...
                                                      name="owner_address" value="<?php echo e(old('owner_address', optional($salesCenter->user)->address)); ?>"><?php echo e(old('owner_address', optional($salesCenter->user)->address)); ?></textarea>
                                            <?php if($errors->has('owner_address')): ?>
                                                <div class="error text-danger"><?php echo app('translator')->get($errors->first('owner_address')); ?></div>
                                            <?php endif; ?>
                                        </div>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\inventory_management\project\resources\views/themes/original/user/salesCenter/edit.blade.php ENDPATH**/ ?>
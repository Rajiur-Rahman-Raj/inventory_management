...
@section('title',trans('Add New Supplier'))
                ...
                <div class="col">
                    <div class="d-flex justify-content-between mb-4">
                        <div class="header-text-full">
                            <h3 class="dashboard_breadcurmb_heading mb-1">@lang('Add New Supplier')</h3>
                            <nav aria-label="breadcrumb" class="ms-2">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('user.suppliers') }}">@lang('Suppliers')</a>
                                    </li>

                                    <li class="breadcrumb-item active"
                                        aria-current="page">@lang('Add Supplier')</li>
                                </ol>
                            </nav>
                        </div>
                        <div>
                    ...
                    <div class="row g-4 g-lg-5">
                        <div class="col-lg-12">
                            <div id="tab1" class="content active">
                                <form action="{{ route('user.supplierStore')}}" method="post"
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="input-box col-12">
                                            <button class="btn-custom w-100"
                                                    type="submit">@lang('Add Supplier')</button>
                                        </div>
                                    </div>
                                </form>
                            </div>

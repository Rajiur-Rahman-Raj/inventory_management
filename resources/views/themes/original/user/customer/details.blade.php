...
@section('title',trans('Customer Details'))
@section('content')
    <!-- main -->
        ...
        <div class="row mt-4 mb-2">
            <div class="col ms-2">
                <div class="header-text-full">
                    <h4 class="dashboard_breadcurmb_heading mb-1">@lang('Customer Details')</h4>
                    <nav aria-label="breadcrumb" class="ms-2">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('Customer Details')</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                                ...
                                                <div class="border-bottom">
                                                    <div class="investmentDate d-flex justify-content-between">
                                                        <h6 class="font-weight-bold text-dark"><i
                                                            ...
                                                            : </h6>
                                                        <p>{{ dateTime($customer->created_at) }}</p>
                                                    </div>
                                                </div>
                                                <ul class="invest-history-details-ul">
                                                    <li class="my-3 list-style-none">
                                                        <span><i class="fal fa-check-circle site__color"
                                                                ...
                                                                class="text-muted">{{ $customer->name }}</span></span>
                                                    </li>
                                                    ...
                                                    @if($customer->email)
                                                        ...
                                                        <span><i class="fal fa-check-circle site__color text-primary"
                                                                ...
                                                                class="text-muted">{{ $customer->email }}</span></span>
                                                        </li>
                                                    @endif
                                                    ...
                                                    <li class="my-3 list-style-none">
                                                        <span><i class="fal fa-check-circle site__color text-primary"
                                                                ...
                                                                class="text-muted">{{ $customer->phone }}</span></span>
                                                    </li>
                                                    ...
                                                    @if($customer->national_id)
                                                        <li class="my-3">
                                                            <span class=""><i
                                                                    ...
                                                                    class="text-muted">{{ $customer->national_id }}</span></span>
                                                        </li>
                                                    @endif
                                                    ...
                                                    <li class="my-3">
                                                        <span>
                                                            ...
                                                            <span
                                                                class="text-muted">{{ optional($customer->division)->name }}</span>
                                                        </span>
                                                    </li>
                                                    ...
                                                    <li class="my-3">
                                                            <span><i
                                                                    ...
                                                                    class="text-muted">{{ optional($customer->district)->name }}</span></span>
                                                    </li>
                                                    ...
                                                    @if($customer->upazila)
                                                        ...
                                                        <span><i class="fal fa-check-circle site__color"
                                                                ...
                                                                class="text-muted">{{ optional($customer->upazila)->name }}</span></span>
                                                        </li>
                                                    @endif
                                                    ...
                                                    @if($customer->union)
                                                        ...
                                                        <span><i
                                                                ...
                                                                class="text-muted">{{ optional($customer->union)->name }}</span></span>
                                                        </li>
                                                    @endif
                                                    ...
                                                    <li class="my-3">
                                                        <span><i class="fal fa-check-circle site__color"
                                                                ...
                                                                class="text-muted">{{ $customer->address }}</span></span>
                                                    </li>

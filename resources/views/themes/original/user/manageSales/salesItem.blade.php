                                ...
                                <div class="total-box">
                                    ...
                                    <div class="total">
                                        ...
                                        <div class="order-btn d-flex flex-wrap">
                                            ...
                                            <button type="button" class="porcced proccedOrderBtn" data-admin="{{ auth()->user() }}">proceed order
                                            </button>

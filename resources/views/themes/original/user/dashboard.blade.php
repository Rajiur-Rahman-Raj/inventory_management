                        ...
                        <div class="product-box shadow-sm p-3 mb-5 bg-body rounded">
                            ...
                            <div class="product-content-box ">
                                ...
                                <div class="shopping-icon d-flex align-items-center justify-content-between" >
                                    ...
                                    ${stock.quantity > 0 ? '<button class="btn btn-sm addToCartButton"><i class="fa fa-cart-plus"></i></button>' : '<button class="btn btn-sm addToCartButton opacity-0 disabled"><i class="fa fa-cart-plus"></i></button>'}
                                </div>

                ...
                <div class="media align-items-center justify-content-between mb-3">
                    ...
                    <?php if(adminAccessRoute(config('role.theme_settings.access.add'))): ?>
                        <a href="<?php echo e(route('admin.content.create',@$content)); ?>"
                           class="btn btn-sm btn-primary btn-rounded"><i class="fa fa-plus-circle"></i> <?php echo app('translator')->get('Create New'); ?></a>
                    <?php endif; ?>
                </div>
                ...
                <div class="table-responsive">
                    <table class="categories-show-table table table-hover table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <?php if(adminAccessRoute(config('role.theme_settings.access.edit')) || adminAccessRoute(config('role.theme_settings.access.delete'))): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\inventory_management\project\resources\views/admin/content/index.blade.php ENDPATH**/ ?>
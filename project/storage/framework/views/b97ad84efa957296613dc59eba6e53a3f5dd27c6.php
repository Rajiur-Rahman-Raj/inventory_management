<?php $__env->startSection('title',trans('Edit Affiliate Member')); ?>
                ...
                <div class="col">
                    <div class="d-flex justify-content-between mb-4">
                        <div class="header-text-full">
                            <h3 class="dashboard_breadcurmb_heading mb-1"><?php echo app('translator')->get('Edit Affiliate Member'); ?></h3>
                            <nav aria-label="breadcrumb" class="ms-2">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a
                                            href="<?php echo e(route('user.affiliateMemberList')); ?>"><?php echo app('translator')->get('Affiliate Member List'); ?></a>
                                    </li>

                                    <li class="breadcrumb-item active"
                                        aria-current="page"><?php echo app('translator')->get('Edit Member'); ?></li>
                                </ol>
                            </nav>
                        </div>
                        <div>
                    ...
                    <div class="row g-4 g-lg-5">
                        <div class="col-lg-12">
                            <div id="tab1" class="content active">
                                <form action="<?php echo e(route('user.affiliateMemberUpdate', $singleAffiliateMember->id)); ?>"
                                      method="post"
                                    ...
                                    <div class="row g-4">
                                        <div class="input-box col-md-6">
                                            ...
                                            <select class="form-select js-example-basic-single"
                                                ...
                                                <?php $__currentLoopData = $saleCenters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $saleCenter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        value="<?php echo e($saleCenter->id); ?>"
                                                        <?php $__currentLoopData = $singleAffiliateMember->salesCenter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salesCenter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php echo e(old('sales_center_id', $salesCenter->id == $saleCenter->id ? 'selected' : '')); ?>

                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    > <?php echo app('translator')->get($saleCenter->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="<?php echo e(old('member_name', $singleAffiliateMember->member_name)); ?>"/>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="email"
                                                   ...
                                                   value="<?php echo e(old('email', $singleAffiliateMember->email)); ?>"/>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   class="form-control"
                                                   value="<?php echo e(old('phone', $singleAffiliateMember->phone)); ?>"/>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <select class="form-select js-example-basic-single selectedDivision"
                                                ...
                                                <?php $__currentLoopData = $divisions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $division): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        value="<?php echo e($division->id); ?>" <?php echo e(old('division_id', optional($singleAffiliateMember->division)->id) == $division->id ? 'selected' : ''); ?>> <?php echo app('translator')->get($division->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <select class="form-select js-example-basic-single selectedDistrict"
                                                    name="district_id"
                                                    aria-label="Default select example"
                                                    data-olddistrictid="<?php echo e($singleAffiliateMember->district_id); ?>">
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <select class="form-select js-example-basic-single selectedUpazila"
                                                    name="upazila_id"
                                                    aria-label="Default select example"
                                                    data-oldupazilaid="<?php echo e($singleAffiliateMember->upazila_id); ?>">
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <select class="form-select js-example-basic-single selectedUnion"
                                                    ...
                                                    data-oldunionid="<?php echo e($singleAffiliateMember->union_id); ?>">
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text" name="member_national_id"
                                                   placeholder="<?php echo app('translator')->get('Member NID'); ?>"
                                                   class="form-control"
                                                   value="<?php echo e(old('member_national_id', $singleAffiliateMember->member_national_id)); ?>"/>
                                            <?php if($errors->has('member_national_id')): ?>
                                                <div
                                                    class="error text-danger"><?php echo app('translator')->get($errors->first('member_national_id')); ?>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text" name="member_commission" placeholder=""
                                                   class="form-control"
                                                   value="<?php echo e(old('member_commission', $singleAffiliateMember->member_commission)); ?>"/>
                                            ...
                                            <div class="flatpickr">
                                                <div class="input-group">
                                                    <input type="date"
                                                           ...
                                                           name="date_of_death"
                                                           value="<?php echo e(old('date_of_death', $singleAffiliateMember->date_of_death)); ?>"
                                                           data-input>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="<?php echo e(old('wife_name', $singleAffiliateMember->wife_name)); ?>"/>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text" name="wife_national_id"
                                                   ...
                                                   class="form-control"
                                                   value="<?php echo e(old('wife_national_id', $singleAffiliateMember->wife_national_id)); ?>"/>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <input type="text" name="wife_commission" placeholder=""
                                                   class="form-control"
                                                   value="<?php echo e(old('wife_commission', $singleAffiliateMember->wife_commission)); ?>"/>
                                        ...
                                        <div class="col-md-12 mb-4 input-box">
                                            <label for="" class="golden-text"><?php echo app('translator')->get('Upload Document'); ?> <span
...
unset($__errorArgs, $__bag); ?>"
                                                      ...
                                                      name="address"><?php echo e(old('address', $singleAffiliateMember->address)); ?></textarea>
                                        ...
                                        <div class="input-box col-12">
                                            <button class="btn-custom w-100" type="submit"><?php echo app('translator')->get('Edit Member'); ?></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\inventory_management\project\resources\views/themes/original/user/affiliate/edit.blade.php ENDPATH**/ ?>
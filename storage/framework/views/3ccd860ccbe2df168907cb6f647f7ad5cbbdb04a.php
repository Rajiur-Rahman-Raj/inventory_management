<?php $__env->startSection('title',trans('Create Employee')); ?>
                ...
                <div class="col">
                    <div class="d-flex justify-content-between mb-4">
                        <div class="header-text-full">
                            <h3 class="dashboard_breadcurmb_heading mb-1"><?php echo app('translator')->get('Create Employee'); ?></h3>
                            <nav aria-label="breadcrumb" class="ms-2">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a
                                            href="<?php echo e(route('user.home')); ?>"><?php echo app('translator')->get('Dashboard'); ?></a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->get('Create Employee'); ?></li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="row g-4 g-lg-5">
                        <div class="col-lg-12">
                            <div id="tab1" class="content active">
                                <form action="<?php echo e(route('user.employeeStore')); ?>" method="post"
                                            ...
                                            <div class="flatpickr">
                                                <div class="input-group">
                                                    <input type="date"
                                                           ...
                                                           name="date_of_birth"
                                                           value="<?php echo e(old('date_of_birth',request()->date_of_birth)); ?>"
                                                           data-input>
                                            ...
                                            <div class="flatpickr">
                                                <div class="input-group">
                                                    <input type="date"
                                                           ...
                                                           name="joining_date"
                                                           value="<?php echo e(old('joining_date',request()->joining_date)); ?>"
                                                           data-input>
                                                    <div class="input-group-append"
                                                         readonly="">
                                                        <div
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <select class="form-select js-example-basic-single"
                                                ...
                                                <option value="1" <?php echo e(old('employee_type', request()->employee_type) == 1 ? 'selected' : ''); ?>> <?php echo app('translator')->get('Full Time'); ?> </option>
                                                <option value="2" <?php echo e(old('employee_type', request()->employee_type) == 2 ? 'selected' : ''); ?>> <?php echo app('translator')->get('Part Time'); ?> </option>
                                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                                       ...
                                                       value="<?php echo e(old('joining_salary')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                       onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')"
                                                       value="<?php echo e(old('current_salary')); ?>">
                                                <div class="input-group-append" readonly="">
                                                    <div class="form-control currency_symbol append_group">
                                                        <?php echo e($basic->currency_symbol); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                value="<?php echo e(old('present_address')); ?>"><?php echo e(old('present_address')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                value="<?php echo e(old('permanent_address')); ?>"><?php echo e(old('permanent_address')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="input-box col-md-6">
                                            ...
                                            <select class="form-select js-example-basic-single"
                                                    name="status"
                                                    aria-label="Default select example">
                                                <option value="1" <?php echo e(old('status', request()->status) == 1 ? 'selected' : ''); ?>> <?php echo app('translator')->get('Active'); ?> </option>
                                                <option value="0" <?php echo e(old('status', request()->status) == 2 ? 'selected' : ''); ?>> <?php echo app('translator')->get('Deactive'); ?> </option>
                                            </select>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\inventory_management\project\resources\views/themes/original/user/employee/create.blade.php ENDPATH**/ ?>
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $forms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td data-label="<?php echo app('translator')->get('Status'); ?>">
                                <span
                                    class="custom-badge badge-pill <?php echo e($data->status == 0 ? 'bg-danger' : 'bg-success'); ?>"><?php echo e($data->status == 0 ? 'Inactive' : 'Active'); ?></span>
                            </td>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td class="text-center text-na" colspan="100%"><?php echo app('translator')->get('No Data Found'); ?></td>
                        </tr>
                    <?php endif; ?>
                    </tbody>
                </table>
            ...
            <div class="modal-content ">
                <form action="" method="post">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus-circle"></i> <?php echo e(trans('Create New')); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <a href="javascript:void(0)" class="btn btn-success btn-sm float-right generate"><i
                                        class="fa fa-plus-circle"></i> <?php echo e(trans('Add Field ddd')); ?></a>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary btn-rounded"> <?php echo e(trans('Update')); ?></button>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\inventory_management\project\resources\views/admin/identify/services.blade.php ENDPATH**/ ?>
...
<div id="sidebar" class="">
    ...
    <ul class="main">
        ...
        <li>
            <a class="<?php echo e(menuActive(['user.companyList'])); ?>" href="<?php echo e(route('user.companyList')); ?>"><i class="fal fa-house-flood"></i><?php echo app('translator')->get('Company List'); ?></a>
        </li>

        <li>
            <a class="<?php echo e(menuActive(['user.salesCenter'])); ?>" href="<?php echo e(route('user.salesCenterList')); ?>"><i class="fal fa-house-flood"></i><?php echo app('translator')->get('Sales Center'); ?></a>
        </li>
        ...
        <li>
            <a class="<?php echo e(menuActive(['user.wishListProperty'])); ?>" href="<?php echo e(route('user.wishListProperty')); ?>"><i class="fal fa-heart"></i><?php echo app('translator')->get('WishList'); ?></a>
        </li>
...
<?php /**PATH C:\xampp\htdocs\inventory_management\project\resources\views/themes/original/partials/sidebar.blade.php ENDPATH**/ ?>
    ...
    <section class="transaction-history">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-end mb-4">
                <a href="<?php echo e(route('user.createCustomer')); ?>" class="btn btn-custom text-white "> <i
                        class="fa fa-plus-circle"></i> <?php echo app('translator')->get('Add Customer'); ?></a>
            </div>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\inventory_management\project\resources\views/themes/original/user/customer/index.blade.php ENDPATH**/ ?>